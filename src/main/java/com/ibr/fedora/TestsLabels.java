...
public TestsLabels() { }
    ...
    return new String[] {
    "3.1.1.-A - LDPNR-LDPNRCreationLinkType",
    ...
    return new String[] {
    "3.1.1.-B - LDPNR-LDPNRCreationWrongLinkType",
    "If, in a successful resource creation request, a Link: rel=\"type\" request header specifies"
    + " the LDP-NR interaction model (http://www.w3.org/ns/ldp#NonRDFSource, regardless of "
    + "Content-Type: value), then the server should handle subsequent requests to the newly "
    + "created resource as if it is an LDP-NR. ([LDP] 5.2.3.4 extension)",
    ...
    return new String[] {
    "3.1.2-B - Container-LDPCContainmentTriples",
    ...
    return new String[] {
    "3.1.2-C - Container-LDPCMembership",
    "LDP Containers must distinguish [containment triples] from [membership] and "
    + "[minimal-container] triples.",
    "https://fcrepo.github.io/fcrepo-specification/#LDPC",
    "MUST"
    ...
    */
    ...
    return new String[] {
    "3.2-A - HttpPatch-SupportHttpPatch",
    ...
    */
    ...
    return new String[] {
    "3.2-B - HttpPatch-LDPPatchContentTypeSupport",
    ...
    */
    ...
    return new String[] {
    "3.2-C - HttpPatch-ServerManagedPropertiesModification",
    ...
    */
    ...
    return new String[] {
    "3.2-D - HttpPatch-StatementNotPersistedResponseBody",
    ...
    */
    ...
    return new String[] {
    "3.2-E - HttpPatch-StatementNotPersistedConstrainedByHeader",
    ...
    */
    ...
    return new String[] {
    "3.2-F - HttpPatch-SuccessfulPatchStatusCode",
    ...
    */
    ...
    return new String[] {
    "3.2.1 - HttpPatch-DisallowPatchContainmentTriples",
    ...
    */
    ...
    return new String[] {
    "3.3-B - HttpPost-ConstrainByResponseHeader",
    ...
    return new String[] {
    "3.3-C - NonRDFSource-PostNonRDFSource",
    ...
    return new String[] {
    "3.3-D - NonRDFSource-PostResourceAndCheckAssociatedResource",
    ...
    return new String[] {
    "3.3.1-A - NonRDFSource-PostDigestResponseHeaderAuthentication",
    ...
    return new String[] {
    "3.3.1-B - NonRDFSource-PostDigestResponseHeaderVerification",
    ...
    return new String[] {
    "3.4.1-B - HttpPut-UpdateDisallowedTriples",
    "f an otherwise valid HTTP PUT request is received that attempts to modify resource statements that a server"
    ...
    return new String[] {
    "3.4.1-C - HttpPut-UpdateDisallowedTriplesResponse",
    ...
    return new String[] {
    "3.4.1-D - HttpPut-UpdateDisallowedTriplesConstrainedByHeader",
    ...
    return new String[] {
    "3.4.2-B - NonRDFSource-PutDigestResponseHeaderAuthentication",
    ...
    return new String[] {
    "3.4.2-C - NonRDFSource-PutDigestResponseHeaderVerification",
    ...
    return new String[] {
    "3.5.1-A - HttpGet-AdditionalValuesForPreferHeader",
    ...
    return new String[] {
    "3.6-B - HttpHead-ResponseHeadersSameAsHttpGet",
    ...
    return new String[] {
    "3.8-A - ExternalBinaryContent-PostCreate",
    ...
    return new String[] {
    "3.8-A - ExternalBinaryContent-PutCreate",
    "Fedora servers should support the creation of LDP-NRs with Content-Type of message/external-body and"
    + " access-type parameter of url.",
    "https://fcrepo.github.io/fcrepo-specification/#external-content",
    "SHOULD"
    ...
    return new String[] {
    "3.8-A - ExternalBinaryContent-PutUpdate",
    "Fedora servers should support the creation of LDP-NRs with Content-Type of message/external-body and"
    + " access-type parameter of url.",
    "https://fcrepo.github.io/fcrepo-specification/#external-content",
    "SHOULD"
    ...
    return new String[] {
    "3.8-C - ExternalBinaryContent-PostCheckUnsupportedMediaType",
    ...
    return new String[] {
    "3.8-C - ExternalBinaryContent-PutCheckUnsupportedMediaType",
    "Fedora servers receiving requests that would create or update a LDP-NR with a message/external-body with an "
    + "unsupported type parameter must respond with HTTP 415 UNSUPPORTED MEDIA TYPE. In the case that a Fedora"
    + " server does not support external LDP-NR content, all message/external-body messages must be rejected"
    + " with HTTP 415.",
    ...
    return new String[] {
    "3.8-E - ExternalBinaryContent-HttpGetCheckContentLocationHeader",
    ...
    return new String[] {
    "3.8-E - ExternalBinaryContent-HttpHeadCheckContentLocationHeader",
    "LDP-NR GET and HEAD responses should include a Content-Location header with a URI representation of the "
    + "location of the external content if the Fedora server is proxying the content.",
    "https://fcrepo.github.io/fcrepo-specification/#external-content",
    "SHOULD"
