...
public class Constants {
    ...
    public static final String ORIGINAL_RESOURCE_LINK_URI = "http://mementoweb.org/ns#OriginalResource";
    public static final String TIME_GATE_LINK_URI = "http://mementoweb.org/ns#TimeGate";
